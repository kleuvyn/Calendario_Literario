...
async function POST(request) {
    try {
        ...
        const existingUsers = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["executeQuery"])("SELECT * FROM users WHERE email = $1", [
            email
        ]);
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["executeQuery"])(`INSERT INTO users (name, email, password) VALUES ($1, $2, $3)`, [
            name,
            email,
            hashedPassword
        ]);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__4fd9bd72._.js.map