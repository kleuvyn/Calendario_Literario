...
"[project]/app/api/user/update-profile/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["executeQuery"])("ALTER TABLE users ADD COLUMN IF NOT EXISTS theme TEXT DEFAULT 'rose';", []);
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["executeQuery"])("SELECT image, theme FROM users WHERE email = $1", [
            email
        ]);
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            ...
            status: 200
        }); // Retorna rose mesmo no erro para não quebrar o gráfico
    }
}
async function POST(request) {
    try {
        ...
        if (image) {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["executeQuery"])("UPDATE users SET image = $1 WHERE email = $2", [
                image,
                session.user.email
            ]);
        }
        if (theme) {
            ...
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["executeQuery"])("ALTER TABLE users ADD COLUMN IF NOT EXISTS theme TEXT DEFAULT 'rose';", []);
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["executeQuery"])("UPDATE users SET theme = $1 WHERE email = $2", [
                theme,
                session.user.email
            ]);
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2fb66462._.js.map