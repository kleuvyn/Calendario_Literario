...
function YearlyReview({ userEmail }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        async function loadAll() {
            ...
            try {
                setLoading(true);
                const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getReadingData"])(userEmail, currentYear);
    ...
    const yearlyStats = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
        if (allBooks.length === 0) return null;
        // 1. Total de páginas
        const totalPages = allBooks.reduce((acc, b)=>acc + (Number(b.total_pages) || 0), 0);
        // 2. Achar o mês que mais leu
        const monthCounts = allBooks.reduce((acc, book)=>{
        ...
        let bestMonthIdx = 0;
        let maxBooks = 0;
        Object.entries(monthCounts).forEach(([idx, count])=>{
            if (count > maxBooks) {
                maxBooks = count;
...
//# sourceMappingURL=_454aa865._.js.map