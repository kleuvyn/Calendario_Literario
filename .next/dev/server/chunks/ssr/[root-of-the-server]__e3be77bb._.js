...
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
    __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__
]);
[__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__;
;
;
async function GET(request) {
    ...
    if (!email || !year) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["NextResponse"].json([]);
    try {
        // 1. Busca os livros (Tabela Principal)
        const booksQuery = `
      SELECT *, total_pages as display_pages 
      FROM public.reading_data 
      WHERE email = $1 AND year = $2
      ORDER BY month ASC, status DESC
    `;
        const books = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["executeQuery"])(booksQuery, [
            email,
            year
        ]);
        // 2. Busca os reviews (Tabela de Gênero/Nota) - Se falhar, não trava os livros
        let reviews = [];
        try {
            const reviewsQuery = `
        ...
        WHERE u.email = $1
      `;
            reviews = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["executeQuery"])(reviewsQuery, [
                email
            ]);
        } catch (e) {
            console.log("Ainda sem tabela de reviews completa, ignorando...");
        }
        // 3. Junta os dados para o componente ler (Genre, Review, Rating)
        const result = books.map((book)=>{
            const rev = reviews.find((r)=>r.title === book.book_name);
            return {
                ...book,
                genre: rev?.genre || "",
                review: rev?.review || "",
                rating: rev?.rating || 0,
                cover_url: rev?.cover_url || book.cover_url
            };
        });
        // RETORNA O ARRAY DIRETO (O que o seu componente espera)
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["NextResponse"].json(result);
    } catch (error) {
        console.error("Erro na API:", error);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["NextResponse"].json([]); // Retorna vazio mas não quebra a tela
    }
}
async function POST(request) {
    try {
        const body = await request.json();
        const { action, email, bookName, rating, coverUrl, totalPages, review, genre } = body;
        if (action === "UPDATE_REVIEW") {
            const userRes = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["executeQuery"])("SELECT id FROM public.users WHERE email = $1", [
                email
            ]);
            if (!userRes.length) throw new Error("Usuário não encontrado");
            const upsertQuery = `
        INSERT INTO public.book_reviews (user_id, title, rating, cover_url, total_pages, review, genre)
      ...
      `;
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["executeQuery"])(upsertQuery, [
                userRes[0].id,
                bookName,
                Number(rating),
                coverUrl,
...
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
    __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$month$2d$review$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__
]);
[__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$month$2d$review$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__;
"use client";
;
;
;
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e3be77bb._.js.map