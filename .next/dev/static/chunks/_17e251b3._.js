...
;
console.log("Conectando ao banco:", __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.DB_NAME, "no host:", __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.DB_HOST);
...
async function GET(request) {
    ...
    try {
        ...
        const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["executeQuery"])("SELECT * FROM reading_data WHERE email = $1 ORDER BY start_date DESC", [
            email
        ]);
...
async function POST(request) {
    ...
    try {
        if (action === "START_READING") {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["executeQuery"])("INSERT INTO reading_data (email, book_name, status, start_date) VALUES ($1, $2, $3, NOW())", [
                email,
                bookName,
                "lendo"
            ]);
        } else if (action === "FINISH_READING") {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["executeQuery"])("UPDATE reading_data SET status = $1, end_date = NOW() WHERE email = $2 AND book_name = $3 AND status = 'lendo'", [
                "concluido",
                email,
                bookName
            ]);
...
//# sourceMappingURL=_17e251b3._.js.map