...
function MonthCalendar({ month, days, year, userEmail, monthIndex }) {
    ...
    async function handleAction(day, action, bookName, oldBookName) {
        if (isUpdating || !userEmail) return;
        const name = action === "START_READING" ? tempBookNames[day] : bookName;
        if (!name && action !== "DELETE_READING") return;
        setIsUpdating(true);
        // FORMATO ISO BRUTO PARA EVITAR ERRO DE FUSO HORÁRIO
        ...
        try {
            ...
            if (action === "START_READING") setTempBookNames((p)=>({
                    ...p,
                    [day]: ""
                }));
            await loadData();
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: Array.from({
                    ...
                    // Normaliza a data do "quadradinho" para comparação
                    ...
                    const dayReadings = readings.filter((r)=>{
                        // Pegamos apenas a parte YYYY-MM-DD das datas do banco
                        const startStr = r.start_date?.split('T')[0];
                        const endStr = r.end_date?.split('T')[0];
                        if (!startStr) return false;
                        // Se o livro já foi lido, ele SÓ aparece entre o dia que começou e o dia que terminou
                        if (r.status === 'lido') {
                            return currentDayStr >= startStr && currentDayStr <= (endStr || startStr);
                        }
                        // Se ainda está lendo, ele aparece do dia que começou até hoje
                        return currentDayStr >= startStr && currentDayStr <= todayStr;
                    });
                    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: dayReadings.map((r, idx)=>{
                                    ...
                                    // Só mostra o botão "Encerrar" no dia atual ou se for o último dia da barra
                                    const showFinishButton = isLendo && currentDayStr === todayStr;
                                    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                        onClick: ()=>{
                                                            ...
                                                            if (newName && newName !== r.book_name) {
                                                                handleAction(day, "EDIT_READING", newName, r.book_name);
                                                            }
                                                        },
...
function MonthReview({ month, userEmail, monthIndex, year }) {
    ...
    const [isSearching, setIsSearching] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const loadData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "MonthReview.useCallback[loadData]": async ()=>{
            ...
            try {
                ...
                }["MonthReview.useCallback[loadData]"]);
    ...
    const stats = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "MonthReview.useMemo[stats]": ()=>{
            ...
            const yearlyFavs = allBooks.filter({
                "MonthReview.useMemo[stats].yearlyFavs": (b)=>Number(bookEdits[b.id]?.rating || b.rating) === 5
            }["MonthReview.useMemo[stats].yearlyFavs"]);
            const favoritesListData = currentMonthBooks.filter({
                "MonthReview.useMemo[stats].favoritesListData": (b)=>Number(bookEdits[b.id]?.rating || b.rating) === 5
            }["MonthReview.useMemo[stats].favoritesListData"]);
            const biggestBookObj = [
                ...currentMonthBooks
            ].sort({
                "MonthReview.useMemo[stats]": (a, b)=>(Number(bookEdits[b.id]?.pages || b.total_pages) || 0) - (Number(bookEdits[a.id]?.pages || a.total_pages) || 0)
    ...
    const currentMonthBooks = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "MonthReview.useMemo[currentMonthBooks]": ()=>{
            return allBooks.filter({
                "MonthReview.useMemo[currentMonthBooks]": (b)=>Number(b.month) === monthIndex + 1
            }["MonthReview.useMemo[currentMonthBooks]"]);
        }
    }["MonthReview.useMemo[currentMonthBooks]"], [
        allBooks,
...
_s(MonthReview, "yaa9fMXVKFgUiTcOpJSRHs4/Rlo=");
_c = MonthReview;
var _c;
...
_s(LoginScreen, "Xtz4c8xFjmHmh32C29aBbm1gWfw=", false, function() {
    return [
...
function Home() {
    ...
    const [activeTheme, setActiveTheme] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('rose');
...
//# sourceMappingURL=_84bc6832._.js.map